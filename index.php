...
<body>
    <header>
        <img class="col-sm-5 col-md-3 col-lg-2" src="assets/img/logo.png" alt="logo da empresa vet abc">
    </header>
    <div class="page-top">
        ...
        <div class="start-page-container">
            ...
            <div class="links">
                ...
                <div class="box-login col-md-2 col-lg-2">
                    <a href="assets/html/cadastro.php">
                        <h2>Cadastro</h2>
    ...
    <main>
        <div id="first-row" class="row">
            <img class="col-sm-8 col-md-7 col-lg-4" src="assets/img/pet-buldog.jpg" alt="">
        ...
        <hr>
        <div class="row">
            <img class="col-sm-8 col-md-7 col-lg-4" src="assets/img/gato.jpeg" alt="">
    ...
    <footer class="rodape col-sm-12 col-md-12 col-lg-12">
        <img src="assets/img/alcina.jpg" class="logo-alcina">
        <img src="assets/img/logo-abc.png" class="logo-abc">
        <div class="info">
    ...
    <script src="assets/javascript/toggle_menu.js"></script>
</body>
</html>