...
if (isset($_POST["cadastrar_animal"])){ #se o botão 'cadastrar_animal' for apertado aconte: 
    ...
    $sql_email_existe =  "SELECT * FROM cadastro WHERE cpf = $cpf_dono"; //essa variavel verifica se o email digitado existe na tabela de cadastro de clientes
    $result=mysqli_query($conexao,$sql_email_existe); //testa a conexão
    ...
    $sql= "INSERT INTO cadanimal (nome_animal, idade, peso, tamanho, tipo_animal, raca) VALUES ('$nome_animal','$idade', '$peso', '$tamanho','$tipo_animal','$raca')";
